...
public class CrunchifyLinkedListTest {
	...
	public static void main(String[] args) {
		...
		//Default constructor - let's put "0" into the head element.
 ...
 */
		...
		System.out.println(".get(3): \t\t\t\t" + crunchifyList.get(3)+ "  (get element at index: 3 - list starts from 0)");
		System.out.println(".size(): \t\t\t\t" + crunchifyList.size());
		System.out.println("Print again: cruncifyList: \t" + crunchifyList);
	}
...
class CrunchifyLinkedList {
	...
	public void add(Object data) {
		...
		if (crunchifyCurrent != null) {
			...
			//starting at the head node, crawl to the end of the list and then add the element
		...
		//increments the number of elements variable
		incrementCounter();
	...
	public void add(Object data, int index) {
		...
		//Let's check for NPE before iterate over crunchifyCurrent
		if(crunchifyCurrent != null) {
			//crawl to the requested index or the last element in the list, whichever is first
